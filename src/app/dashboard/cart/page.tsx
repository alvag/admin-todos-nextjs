...
import { ItemCard } from '@/shopping-card/components/ItemCard';
import { cookies } from 'next/headers';
import { Product, products } from '@/components/products/data/products';
...
const CartPagePage: FC<CartPageProps> = ( {} ) => {
            ...
            <div className="flex flex-col sm:flex-row gap-2 w-full">
                ...
                <div className="flex flex-col w-full sm:w-4/12">
                    <WidgetItem title="Total a pagar">
                        ...
                        <span
                            className="font-bold text-center text-gray-500">Impuestos 15%: $ { ( totalToPay * 0.15 ).toFixed( 2 ) }</span>
                    </WidgetItem>
                </div>
